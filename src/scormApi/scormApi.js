...
class SCORM2004 {
	...
	constructor() {
		...
		this.getIframe = document.querySelector('iframe')
	}
	...
	setLocation() {
		...
		// console.log(currentPage, 'currentPage in setLocation__2004 ')
		// console.log(locationResult, 'locationResult in setLocation__2004 ')
	...
	getLastPage() {
		...
		const lastHtml = route.toString().split('/').slice(-1).join()
	...
	saveData(data) {
		...
		console.log(this.SCORM.get("cmi.score.raw"), 'in saveData')
	...
	checkTotalVisit() {
		...
		if (Object.values(data).length > 0) {
			...
			// console.log(totalVisit, '--totalVisit')

			if (currentScore >= minimum && totalVisit || minimum === 0 && totalVisit) {
